RMapConstant = {
    JsServer: "http://mapdb.365ditu.cn/src/",
    MapRoot: new function() {
        var d = ["http://mapdb0.365ditu.cn/rt/mapdb/", "http://mapdb1.365ditu.cn/rt/mapdb/", "http://mapdb2.365ditu.cn/rt/mapdb/"],
            g = function(d) {
                function c(f, a) {
                    for (var b = 0; a;) b = 2 * b + f % 2, f /= 2, f -= f % 1, a--;
                    return b
                }
                d = String(d);
                var e = 4294967295,
...
RBase = {
    ...
    setIe6ImgPng: function(d) {
        var g = navigator.appVersion.split("MSIE"),
            g = parseFloat(g[1]);
        5.5 <= g && (7 > g && document.body.filters) && (d.outerHTML = "<span " + (d.id ? "id='" + d.id + "' " : "") + (d.className ? "class='" + d.className + "' " :
            "") + (d.title ? "title='" + d.title + "' " : "title='" + d.alt + "' ") + ' style="width:' + d.width + "px; height:" + d.height + "px;" + ("display:inline-block;" + d.style.cssText) + ";filter:progid:DXImageTransform.Microsoft.AlphaImageLoader(src='" + d.src + "', sizingMethod='scale');\"></span>")
    },
    ...
    stopPropagation: function(d) {
        d &&
            d.stopPropagation ? d.stopPropagation() : window.event.cancelBubble = !0
    },
    ...
    getOffset: function(d) {
        ...
        for (var e = 0, h = 0; g;) e += g.offsetLeft, h += g.offsetTop, g = g.offsetParent;
    ...
    getOffsetOnMapDiv: function(d) {
        ...
        var g = !1,
            e = d.target;
        e ? void 0 == e.offsetLeft && (e = e.parentNode) :
            e = d.srcElement;
        for (var h = 0, c = 0; e;) e.MapName && (g = !0), g && (h += e.offsetLeft, c += e.offsetTop), e = e.offsetParent;
    ...
    getMaxCoordinatesBounds: function(d) {
        ...
        if (null != d && 0 < d.length)
            for (var e = 0; e < d.length; e++) 0 < d[e].Cx && 0 < d[e].Cy && (d[e].Cx = parseFloat(d[e].Cx), d[e].Cy = parseFloat(d[e].Cy), g ? (g.MinCoordinates.Cx > d[e].Cx && (g.MinCoordinates.Cx =
                d[e].Cx), g.MinCoordinates.Cy > d[e].Cy && (g.MinCoordinates.Cy = d[e].Cy), g.MaxCoordinates.Cx < d[e].Cx && (g.MaxCoordinates.Cx = d[e].Cx), g.MaxCoordinates.Cy < d[e].Cy && (g.MaxCoordinates.Cy = d[e].Cy)) : g = new RBounds(new RCoordinates(d[e].Cx, d[e].Cy), new RCoordinates(d[e].Cx, d[e].Cy)));
        return g
    },
    getMaxCoordinates: function(d, g) {
        var e = null;
        if (null != d && 0 < d.length)
            for (var h = 0; h < d.length; h++) 0 < d[h].Cx && 0 < d[h].Cy && (d[h].Cx = parseFloat(d[h].Cx), d[h].Cy = parseFloat(d[h].Cy), e ? (Math.abs(d[h].Cx - g.Cx) > Math.abs(e.Cx - g.Cx) && (e.Cx =
                d[h].Cx), Math.abs(d[h].Cy - g.Cy) > Math.abs(e.Lng - g.Cy) && (e.Cy = d[h].Cy)) : e = new RCoordinates(d[h].Cx, d[h].Cy));
        return e
    },
...
RCompute = {
    ...
    getLineDistance: function(d) {
        for (var g = 0, e = 0; e < d.length - 1; e++) g += RCompute.distanceBetween(d[e], d[e + 1]);
        return g
    },
    ...
    getPolygonArea: function(d) {
        for (var g = 0, e = 0; e < d.length; e++) var h = (e + 1) % d.length,
            c = d[e].Cx * Math.PI / 180 * RCompute.EarthRadius,
            k = Math.sin(d[e].Cy *
                Math.PI / 180) * RCompute.EarthRadius,
...
var RTileLayer = function(d, g, e, h, c, k, b, a) {
            ...
            if (null != this.picArr) {
                for (var f = 0; f < this.picArr.length; f++) {
                    for (var a = 0; a < this.picArr[f].length; a++) try {
                        this.Div.get().removeChild(this.picArr[f][a].getCore()), this.picArr[f][a] = null
                    } catch (b) {}
                    this.picArr[f] = null
                }
                this.picArr = null
        ...
        this.initVariable = function() {
            this.xAbsolute = Math.floor(this.Cx /
                this.scalefactor);
            ...
            this.xSpan = Math.ceil(this.MapWidth /
                RMapConstant.MapPicWidth / 2);
        ...
        this.loadBottomPic = function(f) {
            ...
            for (var a = 0; a < f; a++) {
                for (var b = (this.yIndex + 1) % this.picArr[0].length, c = this.picArr[0][this.yIndex].YGrid - 1, d = Math.floor((this.yAbsolute + c) / this.gridfactor), e = parseInt(this.yAbsolute + c - d * this.gridfactor), g = 0; g < this.picArr.length; g++) {
                    var h = [this.MapRoot,
                            this.MapType ? this.MapType + "/" : "", this.directory, "/"
                        ],
        ...
        this.loadLeftPic = function(f) {
            ...
            for (var a = 0; a < f; a++) {
                for (var b = (this.xIndex +
                    1) % this.picArr.length, c = this.picArr[b][0].XGrid - 1, d = Math.floor((this.xAbsolute + c) / this.gridfactor), g = parseInt(this.xAbsolute + c - d * this.gridfactor), e = 0; e < this.picArr[this.xIndex].length; e++) {
                    var h = [this.MapRoot, this.MapType ? this.MapType + "/" : "", this.directory, "/"],
                    ...
                    this.picArr[this.xIndex][e].set(this.picArr[b][0].Left - RMapConstant.MapPicWidth,
                        null, h.concat(d, "/", p, "/", g, "_", k, RMapConstant.PicType).join(""), c, null);
        ...
        this.loadRightPic = function(f) {
            ...
            for (var a = 0; a < f; a++) {
                for (var b = this.picArr[this.xIndex][0].XGrid + 1, c = Math.floor((this.xAbsolute + b) / this.gridfactor), d = parseInt(this.xAbsolute + b - c * this.gridfactor),
                    e = 0; e < this.picArr[this.xIndex].length; e++) {
        ...
        this.setZoom = function(a) {
            for (var b = 0; b < this.Div.get().childNodes.length; b++) {
                ...
                var c = this.MapWidth / 2 - this.Left - (this.MapWidth / 2 - this.Left - this.Div.get().childNodes[b].Left) * a,
                    d = this.MapHeight / 2 -
                    this.Top - (this.MapHeight / 2 - this.Top - this.Div.get().childNodes[b].Top) * a;
    ...
    RImageLoader = function(d, g, e, h, c) {
        ...
        this.set = function(b, c, d, e, g) {
            if (b ||
                0 == b) this.Left = b, a.style.left = this.Left + "px";
            if (c || 0 == c) this.Top = c, a.style.top = this.Top + "px";
...
var RBaseGraphics = function(d, g, e, h, c, k, b, a, f) {
    ...
    this.getMBR = function() {
        ...
        for (var a = this.CoordinatesArr[0].Cx, f = this.CoordinatesArr.Cy, b = a, c = f, n = 1; n < this.CoordinatesArr.length; n++) a = Math.min(a, this.CoordinatesArr[n].Cx), f = Math.min(f, this.CoordinatesArr.Cy),
            b = Math.max(b, this.CoordinatesArr.Cx), c = Math.max(c, this.CoordinatesArr.Cy);
        return {
            minx: a,
            miny: f,
            maxx: b,
    ...
    this.removeEventListener = function(a, f) {
        if (this.EventArray[a]) {
            for (var b = 0; b < this.EventArray[a].length; b++) this.EventArray[a][b] == f && this.EventArray[a].splice(b,
                1);
    ...
    this.dispatchEvent = function(a) {
        if (this.EventArray[a] && 0 < this.EventArray[a].length) {
            ...
            f.Cy = this.Cy;
            f.Hook = this.Hook;
            for (var b = 0; b < this.EventArray[a].length; b++)
                if (this.EventArray[a][b]) this.EventArray[a][b](f)
        }
    }
};
...
baseObject.Context.shadowColor = "RGBA(255,73,71,1)";
baseObject.Context.shadowOffsetX = 0;
baseObject.Context.shadowOffsetY = 0;
baseObject.Context.shadowBlur = 10;
    ...
    this.draw = function() {
        if (f.CoordinatesArr && f.CoordinatesArr.length) {
            ...
            var a = MapUtils.calculatePixDistanceByMi(g, f.Maplet.Level),
                ...
                c =
                RBase.changeToRGBA(f.LineColor, f.LineOpacity);
            if (f.Context) {
                for (var d = [], h = [], k = 0; k < f.CoordinatesArr.length; k++)
                    if (f.CoordinatesArr[k]) {
                        if (f.CoordinatesArr[k + 1]) var l = f.Maplet.toClientPoint(f.CoordinatesArr[k].Cx, f.CoordinatesArr[k].Cy),
                            ...
                            s = l.X + b * (l.Y - m.Y) / Math.sqrt(Math.pow(m.X - l.X, 2) + Math.pow(m.Y -
                                l.Y, 2)),
                            l = l.Y + b * (m.X - l.X) / Math.sqrt(Math.pow(m.X - l.X, 2) + Math.pow(m.Y - l.Y, 2));
                        else l = f.Maplet.toClientPoint(f.CoordinatesArr[k - 1].Cx, f.CoordinatesArr[k - 1].Cy), m = f.Maplet.toClientPoint(f.CoordinatesArr[k].Cx, f.CoordinatesArr[k].Cy), p = m.X - a * (l.Y - m.Y) / Math.sqrt(Math.pow(m.X - l.X, 2) + Math.pow(m.Y - l.Y, 2)), q = m.Y - a * (m.X - l.X) / Math.sqrt(Math.pow(m.X - l.X, 2) + Math.pow(m.Y - l.Y, 2)), s = m.X + b * (l.Y - m.Y) / Math.sqrt(Math.pow(m.X - l.X, 2) + Math.pow(m.Y - l.Y, 2)), l = m.Y + b * (m.X - l.X) / Math.sqrt(Math.pow(m.X - l.X, 2) + Math.pow(m.Y - l.Y,
                            2));
                        d.push({
                            X: p,
                            Y: q
                ...
                c = [];
                for (k =
                    0; k < f.CoordinatesArr.length; k++) f.CoordinatesArr[k] && f.CoordinatesArr[k + 1] && (l = f.Maplet.toClientPoint(f.CoordinatesArr[k].Cx, f.CoordinatesArr[k].Cy), m = f.Maplet.toClientPoint(f.CoordinatesArr[k + 1].Cx, f.CoordinatesArr[k + 1].Cy), p = l.X - a * (l.Y - m.Y) / Math.sqrt(Math.pow(m.X - l.X, 2) + Math.pow(m.Y - l.Y, 2)), q = l.Y - a * (m.X - l.X) / Math.sqrt(Math.pow(m.X - l.X, 2) + Math.pow(m.Y - l.Y, 2)), s = l.X + b * (l.Y - m.Y) / Math.sqrt(Math.pow(m.X - l.X, 2) + Math.pow(m.Y - l.Y, 2)), l = l.Y + b * (m.X - l.X) / Math.sqrt(Math.pow(m.X - l.X, 2) + Math.pow(m.Y - l.Y, 2)),
                    c.push(p + "px," + q + "px"), c.push(s + "px," + l + "px"));
...
RPolygon = function(d, g, e, h, c, k) {
    ...
    this.update = function(a, f, b, c, d,
        e) {
        a && 0 < a.length && (this.CoordinatesArr = a);
    ...
    this.draw = function() {
        if (b.CoordinatesArr && b.CoordinatesArr.length)
            if (b.Context ? b.Context.clearRect(0, 0, b.Graphics.width, b.Graphics.height) : b.Graphics.points.value =
                "", b.Context) {
...
RCircle = function(d, g, e, h, c, k, b) {
    ...
    this.Graphics = document.createElement("canvas");
    this.Graphics.getContext ? (this.Context = this.Graphics.getContext("2d"), this.Div.get().appendChild(this.Graphics)) : (this.Graphics = document.createElement("v:oval"), this.Graphics.unselectable = "on", this.Graphics.style.position = "absolute", this.Div.get().appendChild(this.Graphics), k && b && (this.Fill = document.createElement("v:oval"),
        this.Fill.style.position = "absolute", this.Filled = !0, this.Div.get().appendChild(this.Fill)));
    ...
    this.draw = function() {
        if (a.CenterCoordinates && a.SideCoordinates) {
            ...
            a.Context ? (a.Context.clearRect(0, 0, a.Graphics.width, a.Graphics.height), a.Context.lineWidth = a.LineWidth, a.Context.fillStyle = RBase.changeToRGBA(a.FillColor, a.FillOpacity), a.Context.strokeStyle = RBase.changeToRGBA(a.LineColor, a.LineOpacity),
                a.Context.beginPath(), a.Context.arc(f.X - a.LineWidth, f.Y - a.LineWidth, c, 0, 2 * Math.PI, !0), a.Context.fill(), a.Context.stroke(), a.Context.closePath()) : (a.Graphics.style.left = parseInt(f.X - c - a.LineWidth) + "px", a.Graphics.style.top = parseInt(f.Y - c - a.LineWidth) + "px", a.Fill && (a.Fill.style.left = parseInt(f.X - c) + "px", a.Fill.style.top = parseInt(f.Y - c) + "px"))
        }
    };
    this.refresh = function() {
        if (this.CenterCoordinates && this.SideCoordinates) {
            if (this.Context) this.Graphics.width = this.Maplet.MapWidth, this.Graphics.height = this.Maplet.MapHeight;
            else {
...
RCircleByRadius = function(d, g, e, h, c, k, b) {
    ...
    this.draw = function() {
        if (a.CenterCoordinates && a.Radius) {
            ...
            a.Context ? (a.Context.clearRect(0, 0, a.Graphics.width, a.Graphics.height), a.Context.lineWidth = a.LineWidth, a.Context.fillStyle = RBase.changeToRGBA(a.FillColor, a.FillOpacity), a.Context.strokeStyle = RBase.changeToRGBA(a.LineColor, a.LineOpacity), a.Context.beginPath(), a.Context.arc(f.X -
                a.LineWidth, f.Y - a.LineWidth, b, 0, 2 * Math.PI, !0), a.Context.fill(), a.Context.stroke(), a.Context.closePath()) : (a.Graphics.style.left = parseInt(f.X - a.Radius - a.LineWidth) + "px", a.Graphics.style.top = parseInt(f.Y - a.Radius - a.LineWidth) + "px", a.Fill && (a.Fill.style.left = parseInt(f.X - a.Radius) + "px", a.Fill.style.top = parseInt(f.Y - a.Radius) + "px"))
        }
    };
    this.refresh = function() {
        this.CenterCoordinates && this.Radius && (this.Context ? (this.Graphics.width = this.Maplet.MapWidth, this.Graphics.height = this.Maplet.MapHeight) : (this.Graphics.style.width =
            2 * (this.Radius + this.LineWidth) + "px", this.Graphics.style.height = 2 * (this.Radius + this.LineWidth) + "px", this.Graphics.StrokeColor = this.LineColor, this.Graphics.Stroked = !0, this.Graphics.StrokeWeight = this.LineWidth, this.Graphics.style.filter = "alpha(opacity=" + 100 * this.LineOpacity + ")", this.Fill && (this.Fill.style.width = 2 * this.Radius + "px", this.Fill.style.height = 2 * this.Radius + "px", this.Fill.FillColor = this.FillColor, this.Fill.style.filter = "alpha(opacity=" + 100 * this.FillOpacity + ")")), this.draw())
    }
};
var RBaseMarker = function(d, g, e, h, c, k, b) {
    ...
    this.runMouseDoubleClickEvent = function(f) {
        f = RBase.getMouseEvent(f);
        a.dispatchEvent(RMarkerEvent.MouseDoubleClickEvent,
            f)
    };
    this.EventArray = [];
    ...
    this.dispatchEvent = function(a, b) {
        if (this.EventArray[a] && 0 < this.EventArray[a].length) {
            ...
            c.Cy = this.Cy;
            c.Hook = this.Hook;
            for (var d = 0; d < this.EventArray[a].length; d++)
                if (this.EventArray[a][d]) this.EventArray[a][d](c)
        }
    }
};
...
RLabelMarker = function(d, g, e, h, c, k, b, a) {
    ...
    this.initTag = function() {
        ...
        this.ArrowDiv.get().style.backgroundImage = "url(" + RMapConstant.JsServer +
            "image/tag_arrow.png)";
    ...
    this.refreshTitleLayout = function() {
        ...
        this.ArrowDiv.set((14 + this.TitleWidth + 14 - 12) / 2, null,
            null, null, null);
    ...
    this.setWidthByStrByte = function(a) {
        var f = 0;
        if (a)
            for (var b = 0; b < a.length; b++) 19968 > a.charCodeAt(b) ||
                a.charCodeAt(b), f += 12;
        return f
    };
    this.initTag()
...
RAggregationMarkers = function(d, g, e) {
    ...
    var h = this,
        c = function() {
            for (var a = null, f = 0; f < h.arr.length; f++)
                if (a) {
                ...
                } else a = {}, a[0] = h.arr[f], a[0].arr = [], a[0].arr.push(h.arr[f]);
    ...
    this.getAggregationMarkers =
        function() {
            return h.aggregationMarkers
        };
    this.hideAllMarker = function() {
        if (this.map.pointArr && 0 < this.map.pointArr.length)
            for (var a = 0; a < this.map.pointArr.length; a++) this.map.hideMarker(this.map.pointArr[a])
    };
    this.showAllMarker = function() {
        if (this.map.pointArr && 0 < this.map.pointArr.length)
            for (var a = 0; a < this.map.pointArr.length; a++) this.map.showMarker(this.map.pointArr[a])
    };
...
RRotateMarker = function(d, g, e, h, c, k, b, a, f) {
    ...
    this.rotate = function(a, b, f, c) {
        if (0 < a && 0 < b && 0 < f && 0 < c) {
            ...
            /msie/i.test(d) && !window.opera ? (this.Radian = Math.atan2(f - a, c - b), a = Math.sin(this.Radian), b = Math.cos(this.Radian),
...
RRotateTabMarker = function(d, g, e, h, c, k, b, a, f, n) {
    ...
    this.refresh = function() {
        ...
        this.Icon.style.height = this.IconHeight;
        this.Icon.src = this.IconUrl;
        this.isChangeCxOrCy && (this.isChangeCxOrCy = !1, this.isShowTitle &&
            this.Maplet.refreshTabMarkerBox(this))
    };
    this.showLabel = function() {
        this.Maplet.showTabMarkerBox(this);
        this.isShowTitle = !0
...
RCustomerMarker = function(d, g, e, h, c, k, b) {
    ...
    this.runMouseOutEvent = function(b) {
        b = RBase.getMouseEvent(b);
        a.dispatchEvent(RMarkerEvent.MouseOutEvent,
            b)
    };
    ...
    this.addEventListener = function(a, b) {
        ...
        switch (a) {
            case RMarkerEvent.MouseOverEvent:
                this.Icon.onmouseover || (this.Icon.onmouseover =
                    this.runMouseOverEvent);
                break;
            case RMarkerEvent.MouseOutEvent:
                this.Icon.onmouseout || (this.Icon.onmouseout = this.runMouseOutEvent);
                break;
...
RBaseMap = function(d, g, e, h, c, k, b) {
    ...
    this.zoomDes = 1;
    this.stepCy = this.stepCx = this.newCy =
        this.newCx = this.yStep = this.xStep = this.oldCy = this.oldCx = this.moveCount = this.oldLevel = this.midZoomIndex = this.zoomStep = 0;
    ...
    this.setLocation = function(a, b, c, d, e) {
        if (a || 0 == a || b || 0 == b)
            if (a != this.Left || b != this.Top) this.Left = parseFloat(a), this.Top = parseFloat(b), this.Tilelayers[this.Level].setLeftTop(this.Left, this.Top), this.Tilelayers[this.Level].loadNewPic(), this.Cx = this.oldCx + (this.oldLeft - this.Left) * RMapConstant.ScaleFactors[this.Level] /
                RMapConstant.MapPicWidth, this.Cy = this.oldCy - (this.oldTop - this.Top) * RMapConstant.ScaleFactors[this.Level] / RMapConstant.MapPicHeight, this.setTileLayer(this.Level, this.Cx, this.Cy, this.MapWidth, this.MapHeight);
        if (d || e)
            if (d != this.Cx || e != this.Cy) d = parseFloat(d), e = parseFloat(e), this.Left -= (d - this.Cx) * RMapConstant.MapPicWidth / RMapConstant.ScaleFactors[this.Level], this.Top += (e - this.Cy) * RMapConstant.MapPicHeight / RMapConstant.ScaleFactors[this.Level], this.Tilelayers[this.Level].setLeftTop(this.Left, this.Top),
                this.Tilelayers[this.Level].loadNewPic(), this.Cx = d, this.Cy = e, this.setTileLayer(this.Level, this.Cx, this.Cy, this.MapWidth, this.MapHeight);
    ...
    this.removeTileLayer = function(a) {
        ...
        for (var b = 0; b < this.Div.get().childNodes.length; b++)
            if (this.Div.get().childNodes[b] == this.Tilelayers[a].Div.get()) {
    ...
    this.resize = function(a, b) {
        if ((this.MapWidth !=
            ...
            for (var c = 0; c < RMapConstant.Directorys.length; c++) this.Tilelayers[c].Div.set(null, null, this.MapWidth, this.MapHeight, null), this.Tilelayers[c].MapWidth = this.MapWidth, this.Tilelayers[c].MapHeight = this.MapHeight, this.Tilelayers[c].Cx = this.Cx, this.Tilelayers[c].Cy = this.Cy;
    ...
    this.setCenter = function(a, b) {
        if (a != this.Cx || b != this.Cy) this.Cx = parseFloat(a), this.Cy = parseFloat(b), this.setTileLayer(this.Level, this.Cx, this.Cy, this.MapWidth, this.MapHeight), this.Tilelayers[this.Level].show(), this.Top = this.Left = 0, this.dispatchEvent(RMapEvent.CenterChanged)
    };
    ...
    this.smoothLevelMove = function(a, b, c) {
        ...
        if (this.isCanZoomAndMove()) {
            ...
            this.endCy = b;
            this.endLevel = c;
            d < this.Level && (this.Cx != a || this.Cy != b) ? (this.addEventListener(RMapEvent.LevelChanged, this.zoomHandle), this.ismove = !0, this.smoothLevel(d)) : this.Cx != a || this.Cy != b ? (this.addEventListener(RMapEvent.Moved,
                this.moveHandle), this.smoothMove(a, b)) : this.Level != c && (this.addEventListener(RMapEvent.LevelChanged, this.zoomHandle), this.smoothLevel(c))
        }
    };
    this.zoomHandle = function(b) {
        if (a.ismove) {
            if (a.Cx != a.endCx || a.Cy != a.endCy) a.addEventListener(RMapEvent.Moved, a.moveHandle), a.smoothMove(a.endCx, a.endCy);
    ...
    this.getAppropriateLevelCenter = function(a) {
        ...
        if (a && 0 < a.length) {
            ...
            if (c) {
                b = new RLevelCenter((c.MinCoordinates.Cx + c.MaxCoordinates.Cx) / 2, (c.MinCoordinates.Cy + c.MaxCoordinates.Cy) /
                    2, RMapConstant.MapMaxLevel);
                a = c.MaxCoordinates.Cx - c.MinCoordinates.Cx;
                for (var c = c.MaxCoordinates.Cy - c.MinCoordinates.Cy, d = RMapConstant.Directorys.length - 1; 0 <= d; d--)
                    if (d >= RMapConstant.MapMinLevel && d <= RMapConstant.MapMaxLevel && RMapConstant.ScaleFactors[d] / RMapConstant.MapPicWidth * this.MapWidth > a && RMapConstant.ScaleFactors[d] / RMapConstant.MapPicHeight * this.MapHeight > c) {
                        b.Level = d;
                        break
                    }
    ...
    this.getAppropriateMaxLevel = function(a) {
        ...
        if (0 < a.length) {
            ...
            if (c) {
                ...
                for (var c = 2 * Math.abs(c.Cy - this.Cy), d = RMapConstant.Directorys.length - 1; 0 <= d; d--)
                    if (d >= RMapConstant.MapMinLevel && d <= RMapConstant.MapMaxLevel && RMapConstant.ScaleFactors[d] / RMapConstant.MapPicWidth * this.MapWidth > a && RMapConstant.ScaleFactors[d] / RMapConstant.MapPicHeight * this.MapHeight > c) {
                        b = d;
                        break
                    }
    ...
    this.isCanZoomAndMove = function() {
        return this.isMoving ||
            this.isDraging || this.isZooming || !this.isCanMove ? !1 : !0
    };
    this.startZoom = function() {
        ...
        this.oldZoomStep =
            (RMapConstant.ScaleFactors[this.oldLevel] / RMapConstant.ScaleFactors[this.Level] - 1) / this.zoomCount;
    ...
    this.zooming = function() {
        ...
        if (a.zoomCount == a.midZoomIndex)
            for (var b =
                0; b < a.Div.get().childNodes.length; b++)
                if (a.Div.get().childNodes[b] == a.Tilelayers[a.oldLevel].Div.get()) {
    ...
    this.endZoom = function() {
        ...
        this.Tilelayers[this.oldLevel].Div.get().style.zIndex =
            10;
        this.isZooming = !1;
    ...
    this.proofreadCoordinate = function() {
        ...
        this.Top = this.oldTop + (this.newCy - this.oldCy) *
            RMapConstant.MapPicHeight / RMapConstant.ScaleFactors[this.Level];
    ...
    d = function(b) {
        ...
        if (a.isCanZoomAndMove()) {
            ...
            if (c) {
                ...
                b = b.srcElement || b.currentTarget;
                b.addEventListener ? (window.addEventListener("mousemove", d, !0), window.addEventListener("mouseup", e, !0)) : b.attachEvent &&
                    (b.setCapture(), b.attachEvent("onmousemove", d), b.attachEvent("onmouseup", e));
    ...
    document.addEventListener && a.Div.get().addEventListener("DOMMouseScroll", function(b) {
        b = RBase.getMouseEvent(b);
    ...
    d = function(b) {
        if (!a.EventArray[RMapEvent.MouseDoubleClickEvent] || !a.EventArray[RMapEvent.MouseDoubleClickEvent].length) {
            ...
            if (!b.srcElement || b.srcElement.parentElement != a.Div.get()) {
                for (var c =
                        0, d = 0, e = b.srcElement;
                    "map" != e.getAttribute("_rmap"); e = e.parentElement) c += e.offsetLeft, d += e.offsetTop;
    ...
    this.addEventListener = function(a, b) {
        if (this.EventArray[a]) switch (this.EventArray[a].push(b), a) {
            ...
            case RMapEvent.MouseDoubleClickEvent:
                this.Div.get().ondblclick || (this.Div.get().ondblclick =
                    this.runMouseDoubleClickEvent)
        }
    };
    this.removeEventListener = function(a, b) {
        if (this.EventArray[a]) {
    ...
    this.dispatchEvent = function(a, b, c) {
        if (this.EventArray[a] && 0 < this.EventArray[a].length) {
            ...
            for (b = 0; b < this.EventArray[a].length; b++)
                if (this.EventArray[a][b]) this.EventArray[a][b](d)
        }
    };
    this.addTileLayer(this.Level)
};
RMap = function(d, g, e, h, c, k) {
    ...
    this.removeAllLayers = function() {
        ...
        for (var a = 0; a < this.layerDiv.layers.length; a++) this.layerDiv.layers[a]._pindex = void 0, this.layerDiv.layers[a].dispose();
        this.layerDiv.layers = []
    };
    ...
    this.setCenterMultiple = function(a) {
        for (var b = 0, c = 0, d = 0, e = 0, g = 0; g < a.length; g++) {
    ...
    this.subLevelSelf = function(a, b, c) {
        if (0 > b.X || 0 > b.Y) this.paramLevel -= 1, b = this.toClientPointB(a.Cx, a.Cy, this.paramLevel), this.subLevelSelf(a, b, c)
    };
    this.addLevelSelf = function(a, b, c, d, e) {
        0 < b.X && (0 < b.Y && d.X < this.MapWidth && d.Y < this.MapHeight) && (this.paramLevel +=
            1, b = this.toClientPointB(a.Cx, a.Cy, this.paramLevel), d = this.toClientPointB(c.Cx, c.Cy, this.paramLevel), 0 > b.X || 0 > b.Y ? this.subLevelSelf(a, b, e) : this.addLevelSelf(a, b, c, d, e))
    };
    ...
    this.showMarker = function(a) {
        for (var b = 0; b < this.MarkerArr.length; b++)
            if (this.MarkerArr[b] == a) {
                a.show();
                break
            }
    };
    this.hideMarker = function(a) {
        for (var b = 0; b < this.markerDiv.get().childNodes.length; b++)
            if (this.markerDiv.get().childNodes[b] ==
                a.Div.get()) {
                a.hide();
                break
            }
    ...
    this.removeMarker = function(a) {
        for (var b = 0; b < this.MarkerArr.length; b++)
            if (this.MarkerArr[b] == a) {
                for (var c = 0; c < this.markerDiv.get().childNodes.length; c++)
                    if (this.markerDiv.get().childNodes[c] == a.Div.get()) {
                        this.markerDiv.get().removeChild(a.Div.get());
                        break
                    }
                this.MarkerArr.splice(b,
                    1);
                a && a.dispose();
                break
            }
    ...
    this.showGraphics = function(a) {
        for (var b = 0; b < this.GraphicsArr.length; b++)
            if (this.GraphicsArr[b] == a) {
                a.show();
                break
            }
    };
    this.hideGraphics = function(a) {
        for (var b = 0; b < this.graphicsDiv.get().childNodes.length; b++)
            if (this.graphicsDiv.get().childNodes[b] == a.Div.get()) {
                a.hide();
                break
            }
    };
    ...
    this.removeGraphics = function(a) {
        for (var b = 0; b < this.GraphicsArr.length; b++)
            if (this.GraphicsArr[b] == a) {
                for (var c = 0; c < this.graphicsDiv.get().childNodes.length; c++)
                    if (this.graphicsDiv.get().childNodes[c] == a.Div.get()) {
    ...
    this.removeAllGraphics = function() {
        ...
        if (null != this.GraphicsArr)
            for (; 0 < this.GraphicsArr.length;) this.GraphicsArr.shift()
    };
    ...
    this.runLevelChangedEvent = function(a) {
        ...
        b.refreshAllMarker();
        b.refreshAllGraphics();
        b.markerDiv.get().style.visibility =
            "visible";
    ...
    this.runMoveEvent = function(a) {
        b.graphicsDiv.get().addEventListener ||
            (b.graphicsDiv.get().style.visibility = "hidden")
    };
    ...
    this.hideTabMarkerBox = function(a) {
        (this.SelectTabMarker == a || !a) && this.TabMarkerBox && this.TabMarkerBox.hide()
    };
    this.showTabMarkerBox = function(a) {
        this.SelectTabMarker &&
            (this.SelectTabMarker.hideLabel(), this.SelectTabMarker.Div.get().style.zIndex = 0);
    ...
    this.refreshTabMarkerBox = function(a) {
        ...
        this.TabMarkerBox.get().innerHTML =
            a.TagObject.html
    };
    this.SelectMarker = null;
    this.hideWindowMarkerBox = function(a) {
        if (this.SelectMarker == a || !a) this.WindowMarkerBox.hide(), this.ShadowDiv.hide()
    };
    ...
    this.refreshWindowMarkerBox = function(a) {
        this.WindowMarkerBox || (this.WindowMarkerBox =
            new RDiv(null, null, null, null, 1E4), this.WindowMarkerBox.get().oncontextmenu = function(a) {
                return !1
                ...
                RBase.stopPropagation(a)
            }, this.WindowMarkerBox.get().ondblclick =
            function(a) {
                RBase.stopPropagation(a)
            }, this.WindowMarkerBox.ContentDiv = new RDiv(0, 0, null, null, 0), this.WindowMarkerBox.ContentDiv.get().style.border = "1px solid #999999", this.WindowMarkerBox.ContentDiv.get().style.background = "#FFFFFF", this.WindowMarkerBox.BottomDiv = new RDiv(null, null, 51, 31, 0), this.WindowMarkerBox.BottomDiv.get().style.background = "url(" + RMapConstant.JsServer + "image/marker_bottom.png)", window.XMLHttpRequest || RBase.setIe6BackgroundPng(this.WindowMarkerBox.BottomDiv), this.WindowMarkerBox.get().appendChild(this.WindowMarkerBox.ContentDiv.get()),
            this.WindowMarkerBox.get().appendChild(this.WindowMarkerBox.BottomDiv.get()), this.markerDiv.get().appendChild(this.WindowMarkerBox.get()), this.ShadowDiv || (this.ShadowDiv = new RDiv(null, null, null, null, -1), this.ShadowDiv.get().oncontextmenu = function(a) {
                return !1
        ...
        this.WindowMarkerBox.ContentDiv.set(null, null, a.TagObject.width, a.TagObject.height,
            null);
        ...
        if (this.ShadowDiv) {
            ...
            if (c && d) {
                ...
                if (window.XMLHttpRequest)
                    for (b = 0; b < c.length; b++) a += "<div style='left: " + c[b].left + "px; top: " + c[b].top + "px; width: " +
                        c[b].width + "px; height: " + c[b].height + "px; position: absolute; overflow: hidden; z-index: 1;'><img style='width:1144px;height:370px;position:absolute;left:" + c[b].imgLeft + "px;top:" + c[b].imgTop + "px;' src='" + RMapConstant.JsServer + "image/marker_shadow.png'  onmousedown='return false;'></div>";
                else
                    for (b = 0; b < c.length; b++) a += "<div style='left: " + c[b].left + "px; top: " + c[b].top + "px; width: " + c[b].width + "px; height: " + c[b].height + "px; position: absolute; overflow: hidden; z-index: 1;'><span style='width:1144px;height:370px;left:" +
                        c[b].imgLeft + "px;top:" + c[b].imgTop + "px;position:absolute;filter:progid:DXImageTransform.Microsoft.AlphaImageLoader (src=" + RMapConstant.JsServer + "image/marker_shadow.png, sizingMethod=scale);' onmousedown='return false;'></span></div>";
...
RGeometry = {
    ...
    isPointOnPath: function(d, g) {
        ...
        for (var e = null, h = null, e = d[0], c = 1; c < d.length; c++) {
            h = d[c];
    ...
    isPointInPolygon: function(d, g) {
        if (!d || 3 > d.length || !g) return -1;
        for (var e = 0, h = 0, c = null, k = null, c = d[d.length - 1], b = 0; b < d.length; b++) {
            k = d[b];
    ...
    isPointInCircle: function(d, g, e) {
        g = Math.sqrt(Math.pow(Math.abs(g.Cx - d.Cx), 2) + Math.pow(Math.abs(g.Cy - d.Cy),
            2));
...
RToolManager = function(d) {
    ...
    this.addScale = function(a, b, d, f) {
        ...
        if (d || 0 == d) this.Scale.get().style.left =
            null, this.Scale.get().style.right = d + "px";
        if (f || 0 == f) this.Scale.get().style.top = null, this.Scale.get().style.bottom = f + "px";
        ...
        this.Scale.MiddleDiv.get().style.background =
            "url(" + RMapConstant.JsServer + "image/tool/scale_bg.gif) no-repeat";
    ...
    this.addCopyright = function(a, b, c, d, f) {
        if (f) {
            this.Copyright = new RDiv(a, b, null,
                null, k);
            if (c || 0 == c) this.Copyright.get().style.left = null, this.Copyright.get().style.right = c + "px";
            if (d || 0 == d) this.Copyright.get().style.top = null, this.Copyright.get().style.bottom = d + "px";
            this.Div.get().appendChild(this.Copyright.get());
    ...
    this.addZoomDirectBar = function(b, c, d, f) {
        ...
        if (d || 0 == d) this.ZoomDirectBar.Div.get().style.left = null, this.ZoomDirectBar.Div.get().style.right = d + "px";
        if (f || 0 == f) this.Copyright.get().style.top = null, this.Copyright.get().style.bottom = f + "px";
    ...
    this.removeTool = function(a) {
        for (var b = 0; b < this.toolArr.length; b++)
            if (a == this.toolArr[b]) {
    ...
    this.addRightMenu = function(a, b, c) {
        this.RightMenu ||
            (this.RightMenu = new RRightMenu(a, b, c, f), this.RightMenu.close(), this.Div.get().appendChild(this.RightMenu.Div.get()), this.Maplet.addEventListener(RMapEvent.MouseRightButtonEvent, this.runRightButtonEvent), this.Maplet.addEventListener(RMapEvent.MouseDownEvent, this.closeRightMenu))
    };
    ...
    this.refreshAllTool = function() {
        if (g.toolDiv)
            for (var a =
                0; a < g.toolArr.length; a++) g.toolArr[a].refresh()
    };
    this.runSizeChangedEvent = function(a) {
...
var REagleMap = function(d, g, e, h, c) {
        ...
        this.refreshFloatDiv = function() {
            var b = this.Maplet.getBounds(),
                ...
                b = RMapConstant.MapPicWidth / RMapConstant.ScaleFactors[this.Level] *
                (b.MaxCoordinates.Cy - b.MinCoordinates.Cy);
        ...
        this.runLevelChangedEvent = function(b) {
            k.Maplet.Level -
                4 >= RMapConstant.MapMinLevel ? (k.show(), k.setLevel(k.Maplet.Level - 4)) : k.hide();
            k.refreshFloatDiv()
        };
        this.runCenterChangedEvent = function(b) {
            (k.Cx != k.Maplet.Cx || k.Cy != k.Maplet.Cy) && k.setCenter(k.Maplet.Cx, k.Maplet.Cy)
        };
        this.runMovedEvent = function(b) {
            (k.Cx != k.Maplet.Cx || k.Cy != k.Maplet.Cy) && k.move(k.Maplet.Cx, k.Maplet.Cy)
        };
        this.Maplet.addEventListener(RMapEvent.SizeChanged, this.runSizeChangedEvent);
        this.Maplet.addEventListener(RMapEvent.LevelChanged, this.runLevelChangedEvent);
        this.Maplet.addEventListener(RMapEvent.CenterChanged,
            this.runCenterChangedEvent);
        this.Maplet.addEventListener(RMapEvent.Moved, this.runMovedEvent);
        this.mMovedEvent = function(b) {
            (k.Cx != k.Maplet.Cx || k.Cy != k.Maplet.Cy) && k.Maplet.move(k.Cx, k.Cy)
        };
    ...
    RZoomDirectBar = function(d, g) {
        ...
        this.SouthDiv.get().onclick = function(d) {
            d = e.Maplet.Cy - Math.round(e.Maplet.MapHeight / 3) * (RMapConstant.ScaleFactors[e.Maplet.Level] /
                RMapConstant.MapPicHeight);
        ...
        this.ZoominDiv.get().style.cursor =
            "pointer";
        ...
        this.StripDiv.get().style.background =
            "url(" + RMapConstant.JsServer + "image/tool/bar_strip_bg.png)";
        ...
        this.SliderDiv.get().onmousedown = function(d) {
            ...
            e.SliderDiv.get().onmouseup = function(c) {
                ...
                e.SliderDiv.set(null, c);
                e.StripDiv2.set(null, c + 2, null, e.StripDivHeight - c + 19, null);
                c = RMapConstant.MapMaxLevel - Math.floor((c -
                    18 + 3) / 7);
...
RBaseTool = function(d) {
    ...
    this.removeEventListener = function(d, e) {
        if (this.EventArray[d])
            for (var h = 0; h < this.EventArray[d].length; h++) this.EventArray[d][h] == e && this.EventArray[d].splice(h, 1)
    };
    this.dispatchEvent = function(d) {
        if (this.EventArray[d] && 0 < this.EventArray[d].length)
            for (var e = new RToolEvent(d), h = 0; h < this.EventArray[d].length; h++)
                if (this.EventArray[d][h]) this.EventArray[d][h](e)
    }
};
RLineTool = function(d, g, e, h) {
    ...
    this.isAddEvent = !1;
    this.open = function() {
        c.isOpened || (c.clear(), c.isOpened = !0, RCursor.setMouseTool(), c.Maplet.Div.get().style.cursor = RCursor.MouseNormalCursor, c.GraphicsObject = new RLine([], g, e, h), c.GraphicsObject.setMaplet(c.Maplet), c.GraphicsObject.Div.get().setAttribute("_rmap", "RLineTool"), c.Div.get().appendChild(c.GraphicsObject.Div.get()), c.Maplet.addEventListener(RMapEvent.MouseDownEvent, c.onMouseDown),
            c.dispatchEvent(RToolEvent.OpenTool))
    };
    this.close = function() {
        c.isOpened && (c.isOpened = !1, RCursor.setMouseDefault(), c.Maplet.Div.get().style.cursor = RCursor.MouseNormalCursor, c.Maplet.removeEventListener(RMapEvent.MouseDownEvent, c.onMouseDown), c.isAddEvent && (c.isAddEvent = !1, c.Maplet.removeEventListener(RMapEvent.MouseMoveEvent, c.onMouseMove), c.Maplet.removeEventListener(RMapEvent.MouseDoubleClickEvent, c.onMouseDoubleClick)), 0 < c.GraphicsObject.CoordinatesArr.length && (c.GraphicsObject.CoordinatesArr.pop(),
            c.GraphicsObject.refresh()), c.CoordinatesArr = c.GraphicsObject.CoordinatesArr, c.dispatchEvent(RToolEvent.CloseTool))
    };
    this.clear = function() {
        !c.isOpened && null != c.GraphicsObject && (c.Div.get().removeChild(c.GraphicsObject.Div.get()), c.GraphicsObject.dispose(), c.GraphicsObject = null, c.CoordinatesArr = [], c.dispatchEvent(RToolEvent.ClearGraphics))
    };
    this.refresh = function() {
        c.GraphicsObject && c.GraphicsObject.CoordinatesArr && c.GraphicsObject.refresh()
    };
    this.onMouseDown = function(d) {
        if (c.isOpened && (2 < Math.abs(c.oldX -
            d.MouseX) || 2 < Math.abs(c.oldY - d.MouseY))) {
            c.oldX = d.MouseX;
            c.oldY = d.MouseY;
            d = new RCoordinates(d.MouseCx, d.MouseCy);
            if (0 >= c.GraphicsObject.CoordinatesArr.length) c.GraphicsObject.CoordinatesArr[0] = d, c.GraphicsObject.CoordinatesArr[c.GraphicsObject.CoordinatesArr.length] = null;
            else if (d.Cx != c.GraphicsObject.CoordinatesArr[c.GraphicsObject.CoordinatesArr.length - 2].Cx || d.Cy != c.GraphicsObject.CoordinatesArr[c.GraphicsObject.CoordinatesArr.length - 2].Cy) c.GraphicsObject.CoordinatesArr[c.GraphicsObject.CoordinatesArr.length -
                1] = d, c.GraphicsObject.CoordinatesArr[c.GraphicsObject.CoordinatesArr.length] = null;
...
RPolygonTool = function(d, g, e, h, c, k) {
    ...
    this.isAddEvent = !1;
    this.open = function() {
        b.isOpened || (b.clear(), b.isOpened = !0, RCursor.setMouseTool(), b.Maplet.Div.get().style.cursor = RCursor.MouseNormalCursor, b.GraphicsObject = new RPolygon([], g, e, h, c, k), b.GraphicsObject.setMaplet(b.Maplet), b.GraphicsObject.Div.get().setAttribute("_rmap", "RPolygonTool"), b.Div.get().appendChild(b.GraphicsObject.Div.get()), b.Maplet.addEventListener(RMapEvent.MouseDownEvent,
    ...
    this.clear = function() {
        !b.isOpened && null != b.GraphicsObject && (b.Div.get().removeChild(b.GraphicsObject.Div.get()), b.GraphicsObject.dispose(), b.GraphicsObject = null, b.CoordinatesArr = [], b.dispatchEvent(RToolEvent.ClearGraphics))
    };
    this.refresh = function() {
    ...
    this.onMouseDown = function(a) {
        if (b.isOpened && (2 < Math.abs(b.oldX -
            a.MouseX) || 2 < Math.abs(b.oldY - a.MouseY))) {
            b.oldX = a.MouseX;
            b.oldY = a.MouseY;
            a = new RCoordinates(a.MouseCx, a.MouseCy);
            if (0 >= b.GraphicsObject.CoordinatesArr.length) b.GraphicsObject.CoordinatesArr[0] = a, b.GraphicsObject.CoordinatesArr[b.GraphicsObject.CoordinatesArr.length] = null;
            else if (a.Cx != b.GraphicsObject.CoordinatesArr[b.GraphicsObject.CoordinatesArr.length - 2].Cx || a.Cy != b.GraphicsObject.CoordinatesArr[b.GraphicsObject.CoordinatesArr.length - 2].Cy) b.GraphicsObject.CoordinatesArr[b.GraphicsObject.CoordinatesArr.length -
                1] = a, b.GraphicsObject.CoordinatesArr[b.GraphicsObject.CoordinatesArr.length] = null;
...
RDistanceTool = function(d, g, e, h) {
    ...
    this.isAddEvent = !1;
    this.open = function() {
        c.isOpened || (c.clear(), c.isOpened = !0, RCursor.setMouseTool(), c.Maplet.Div.get().style.cursor = RCursor.MouseNormalCursor, c.GraphicsObject = new RLine([], g, e, h), c.GraphicsObject.setMaplet(c.Maplet), c.GraphicsObject.Div.get().setAttribute("_rmap", "RDistanceTool"), c.Div.get().appendChild(c.GraphicsObject.Div.get()), c.Maplet.addEventListener(RMapEvent.MouseDownEvent,
            c.onMouseDown), c.dispatchEvent(RToolEvent.OpenTool))
    };
    this.close = function() {
        c.isOpened && (c.isOpened = !1, RCursor.setMouseDefault(), c.Maplet.Div.get().style.cursor = RCursor.MouseNormalCursor, c.Maplet.removeEventListener(RMapEvent.MouseDownEvent, c.onMouseDown), c.isAddEvent && (c.isAddEvent = !1, c.Maplet.removeEventListener(RMapEvent.MouseMoveEvent, c.onMouseMove), c.Maplet.removeEventListener(RMapEvent.MouseDoubleClickEvent, c.onMouseDoubleClick)), 0 < c.GraphicsObject.CoordinatesArr.length && (c.GraphicsObject.CoordinatesArr.pop(),
            c.GraphicsObject.refresh()), c.CoordinatesArr = c.GraphicsObject.CoordinatesArr, c.dispatchEvent(RToolEvent.CloseTool))
    ...
    this.clear = function() {
        if (!c.isOpened && null != c.GraphicsObject) {
            ...
            for (c.GraphicsObject = null; 0 < c.tipsDivArr.length;) c.Div.get().removeChild(c.tipsDivArr[c.tipsDivArr.length - 1].get()), c.tipsDivArr[c.tipsDivArr.length - 1] = null, c.tipsDivArr.pop();
            c.CoordinatesArr = [];
    ...
    this.refresh =
        function() {
            if (c.GraphicsObject && c.GraphicsObject.CoordinatesArr) {
                for (var d = 0; d < c.GraphicsObject.CoordinatesArr.length; d++)
                    if (c.tipsDivArr[d]) {
    ...
    this.onMouseDown = function(d) {
        if (c.isOpened && (2 < Math.abs(c.oldX - d.MouseX) || 2 < Math.abs(c.oldY - d.MouseY))) {
            ...
            if (0 >= c.GraphicsObject.CoordinatesArr.length) c.GraphicsObject.CoordinatesArr[0] =
                b, c.GraphicsObject.CoordinatesArr[c.GraphicsObject.CoordinatesArr.length] = null, c.addTipsDiv(d.MouseX, d.MouseY, "\u8d77\u70b9");
            else if (b.Cx != c.GraphicsObject.CoordinatesArr[c.GraphicsObject.CoordinatesArr.length - 2].Cx || b.Cy != c.GraphicsObject.CoordinatesArr[c.GraphicsObject.CoordinatesArr.length - 2].Cy) c.GraphicsObject.CoordinatesArr[c.GraphicsObject.CoordinatesArr.length - 1] = b, c.GraphicsObject.CoordinatesArr[c.GraphicsObject.CoordinatesArr.length] = null, b = Math.round(RCompute.getLineDistance(c.GraphicsObject.CoordinatesArr.slice(0,
                c.GraphicsObject.CoordinatesArr.length - 1))), c.addTipsDiv(d.MouseX, d.MouseY, 1E3 <= b ? b / 1E3 + "\u516c\u91cc" : b + "\u7c73");
            c.isAddEvent || (c.Maplet.addEventListener(RMapEvent.MouseMoveEvent, c.onMouseMove), c.Maplet.addEventListener(RMapEvent.MouseDoubleClickEvent, c.onMouseDoubleClick), c.isAddEvent = !0)
        }
    };
    this.onMouseMove = function(d) {
    ...
    this.addTipsDiv = function(d, b, a) {
        ...
        a.get().style.background =
            "url(" + RMapConstant.JsServer + "image/tool/tool_point_icon.gif) no-repeat";
...
RAreaTool = function(d, g, e, h, c, k) {
    ...
    this.clear = function() {
        if (!b.isOpened && null != b.GraphicsObject) {
            ...
            for (b.labelDiv.hide(); 0 < b.tipsDivArr.length;) b.Div.get().removeChild(b.tipsDivArr[b.tipsDivArr.length - 1].get()), b.tipsDivArr[b.tipsDivArr.length - 1] = null, b.tipsDivArr.pop();
            b.CoordinatesArr = [];
    ...
    this.refresh = function() {
        if (b.GraphicsObject && b.GraphicsObject.CoordinatesArr) {
            for (var a = 0; a < b.GraphicsObject.CoordinatesArr.length; a++)
                if (b.tipsDivArr[a]) {
    ...
    this.onMouseDown = function(a) {
        if (b.isOpened && (2 < Math.abs(b.oldX - a.MouseX) || 2 < Math.abs(b.oldY - a.MouseY))) {
            ...
            if (0 >= b.GraphicsObject.CoordinatesArr.length) b.GraphicsObject.CoordinatesArr[0] = c, b.GraphicsObject.CoordinatesArr[b.GraphicsObject.CoordinatesArr.length] = null, b.addTipsDiv(a.MouseX, a.MouseY);
            else if (c.Cx != b.GraphicsObject.CoordinatesArr[b.GraphicsObject.CoordinatesArr.length - 2].Cx || c.Cy != b.GraphicsObject.CoordinatesArr[b.GraphicsObject.CoordinatesArr.length - 2].Cy) b.GraphicsObject.CoordinatesArr[b.GraphicsObject.CoordinatesArr.length -
                1] = c, b.GraphicsObject.CoordinatesArr[b.GraphicsObject.CoordinatesArr.length] = null, c = RCompute.getPolygonArea(b.GraphicsObject.CoordinatesArr.slice(0, b.GraphicsObject.CoordinatesArr.length - 1)), c = 1E6 > c ? Math.round(c) + "\u5e73\u65b9\u7c73" : Math.round(c / 1E3) / 1E3 + "\u5e73\u65b9\u516c\u91cc", b.addTipsDiv(a.MouseX, a.MouseY, c);
            b.isAddEvent || (b.Maplet.addEventListener(RMapEvent.MouseMoveEvent, b.onMouseMove), b.Maplet.addEventListener(RMapEvent.MouseDoubleClickEvent, b.onMouseDoubleClick), b.isAddEvent = !0)
        }
    };
    this.onMouseMove =
    ...
    this.addTipsDiv = function(a, c, d) {
        ...
        b.tipsDivArr.push(e);
        d && (b.labelDiv.set(a + 10, c - 10, 7 * (d.length - 3) + 38, null, null), b.labelDiv.get().innerHTML =
            d, b.labelDiv.show())
    };
...
RRectTool = function(d, g, e, h, c, k) {
    ...
    this.clear = function() {
        !b.isOpened && null != b.GraphicsObject && (b.Div.get().removeChild(b.GraphicsObject.Div.get()), b.GraphicsObject.dispose(), b.GraphicsObject = null, b.CoordinatesArr = [], b.startPoint = null, b.endPoint = null, b.dispatchEvent(RToolEvent.ClearGraphics))
    };
    this.refresh = function() {
        b.GraphicsObject && b.GraphicsObject.CoordinatesArr && b.GraphicsObject.refresh()
    };
    this.isClickDown = !1;
    this.onMouseDown = function(a) {
        b.isOpened && !b.isClickDown && (b.isClickDown = !0, startPoint = new RCoordinates(a.MouseCx, a.MouseCy),
            b.Maplet.addEventListener(RMapEvent.MouseUpEvent, b.onMouseUp), b.Maplet.addEventListener(RMapEvent.MouseMoveEvent, b.onMouseMove))
    };
...
RCircleTool = function(d, g, e, h, c, k) {
    ...
    this.endPoint;
    this.open = function() {
        b.isOpened || (b.clear(), b.isOpened = !0, RCursor.setMouseTool(), b.Maplet.Div.get().style.cursor = RCursor.MouseNormalCursor, b.GraphicsObject = new RCircle({}, {}, g, e, h, c, k), b.GraphicsObject.setMaplet(b.Maplet), b.GraphicsObject.Div.get().setAttribute("_rmap", "RCircleTool"), b.Div.get().appendChild(b.GraphicsObject.Div.get()), b.Maplet.addEventListener(RMapEvent.MouseDownEvent, b.onMouseDown),
            b.Maplet.isCanMove = !1, b.dispatchEvent(RToolEvent.OpenTool))
    };
    this.close = function() {
        b.isOpened && (b.isOpened = !1, b.Maplet.removeEventListener(RMapEvent.MouseDownEvent, b.onMouseDown), b.Maplet.removeEventListener(RMapEvent.MouseUpEvent, b.onMouseUp), b.Maplet.removeEventListener(RMapEvent.MouseMoveEvent, b.onMouseMove), RCursor.setMouseDefault(), b.Maplet.Div.get().style.cursor = RCursor.MouseNormalCursor, b.centerCoordinates = b.GraphicsObject.centerCoordinates, b.sideCoordinates = b.GraphicsObject.sideCoordinates,
            b.Maplet.isCanMove = !0, b.dispatchEvent(RToolEvent.CloseTool))
    };
    this.clear = function() {
        !b.isOpened && null != b.GraphicsObject && (b.Div.get().removeChild(b.GraphicsObject.Div.get()), b.GraphicsObject.dispose(), b.GraphicsObject = null, b.CoordinatesArr = [], b.startPoint = null, b.endPoint = null, b.dispatchEvent(RToolEvent.ClearGraphics))
    };
...
RAddPointTool = function(d, g, e, h, c, k) {
    ...
    this.close = function() {
        b.isOpened && (b.isOpened = !1, RCursor.setMouseDefault(), b.Maplet.Div.get().style.cursor =
            RCursor.MouseNormalCursor, b.Maplet.removeEventListener(RMapEvent.MouseUpEvent, b.onMouseUp), b.Maplet.removeEventListener(RMapEvent.Moving, b.onMapMoving), b.PointMarker && (b.Cx = b.PointMarker.Cx, b.Cy = b.PointMarker.Cy), b.dispatchEvent(RToolEvent.CloseTool))
    };
    this.clear = function() {
    ...
    this.refresh = function(a) {
        b.PointMarker.update(a.MouseCx,
            a.MouseCy)
    };
    this.onMouseUp = function(a) {
...
__RLayer = function(d, g, e, h) {
    ...
    this.Div.get().style.overflow = "hidden";
    for (d = 0; d < RMapConstant.Directorys.length; d++) this.Tilelayers[d] = d >= RMapConstant.MapMinLevel ||
        d <= RMapConstant.MapMaxLevel ? new RTileLayer(this.Cx, this.Cy, d, this.MapWidth, this.MapHeight, 0, this.MapRoot, this.MapType) : null;
    this.getCenter = function() {
        return new RCoordinates(this.Cx, this.Cy)
    };
    this.setCenter = function(a, b) {
        if (a != this.Cx || b != this.Cy) this.Top = this.Left = 0, this.Cx = a, this.Cy = b, this.setTileLayer(this.Level, this.Cx, this.Cy, this.MapWidth, this.MapHeight), this.Tilelayers[this.Level].setLeftTop(0, 0), this.Tilelayers[this.Level].show()
    };
    this.resize = function(a, b) {
        this.MapWidth = a;
        this.MapHeight = b;
    ...
    this.setLocation = function(a, b, d, e, g) {
        if (a || 0 == a || b || 0 == b)
            if (a !=
                this.Left || b != this.Top) this.Left = a, this.Top = b, this.Tilelayers[this.Level].setLeftTop(this.Left, this.Top), this.Tilelayers[this.Level].loadNewPic(), this.Cx = e, this.Cy = g, this.setTileLayer(this.Level, this.Cx, this.Cy, this.MapWidth, this.MapHeight);
        null != d && (void 0 != d && d >= RMapConstant.MapMinLevel && d <= RMapConstant.MapMaxLevel) && this.Level != d && (this.removeTileLayer(this.Level), this.Top = this.Left = 0, this.Level = d, this.setTileLayer(this.Level, this.Cx, this.Cy, this.MapWidth, this.MapHeight), this.Tilelayers[this.Level].setLeftTop(0,
            0), this.addTileLayer(this.Level));
    ...
    this.dispose = function() {
        this.clearHotspot();
        for (this.removeTileLayer(this.Level); 0 < this.Tilelayers.length;) this.Tilelayers[0] &&
            (this.Tilelayers[0].clear(), this.Tilelayers[0] = null), this.Tilelayers.pop();
        ...
        this.Maplet.removeEventListener(RMapEvent.Moving,
            this.runMovingEvent)
    };
    this.runSizeChangedEvent = function(a) {
    ...
    this.Maplet.addEventListener(RMapEvent.SizeChanged,
        this.runSizeChangedEvent);
    this.Maplet.addEventListener(RMapEvent.LevelChanged, this.runLevelChangedEvent);
    this.Maplet.addEventListener(RMapEvent.CenterChanged, this.runCenterChangedEvent);
    this.Maplet.addEventListener(RMapEvent.Moved, this.runMovedEvent);
    this.Maplet.addEventListener(RMapEvent.Moving, this.runMovingEvent);
        ...
        if (k) {
            ...
            for (var b in k) {
                ...
                if (!d.marker && RCompute.distanceBetween({
                    ...
                    3E3) * RMapConstant.ScaleFactors[c.Maplet.Level]) d.marker = new RLabelMarker(d.lng, d.lat, d.name, RMapConstant.JsServer + "image/hotspot.png", -8, -8, 16, 16), c.Maplet.addMarker(d.marker), d.marker.showLabel()
            }
    ...
    this.clearHotspot = function() {
        if (k) {
            ...
            c.Maplet.refreshAllMarker();
            c.Maplet.removeEventListener(RMapEvent.SizeChanged,
                k.setup);
    ...
    this.setHotspot = function(a) {
        ...
        k.setup = function() {
            ...
            b = window.setTimeout(function() {
                ...
                var d = c.Maplet.getBounds(),
                    e;
                do e = "RmapHotspot_" + (Math.random().toString() + Math.random().toString()).replace(/\./g, "D"); while (window[e]);
                window[e] = function(a) {
                    if (k &&
                        a && a.length)
        ...
        c.Maplet.addEventListener(RMapEvent.CenterChanged,
            k.setup);
